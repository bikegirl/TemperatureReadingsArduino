...
{ 
  ...
  while (1)
  {
    ...
    if(celsius){
      ...
      float FDecFloat = Decimal; 
      FDecFloat = FDecFloat/10000; 
      float FtempFloat = Temperature_H;
      FtempFloat = FtempFloat + FDecFloat;  
      FtempFloat = FtempFloat*1.8;        
      FtempFloat = FtempFloat+32;       
      int Ftemp = (int) FtempFloat;
      FDecFloat = FtempFloat - Ftemp;
      int FDec = FDecFloat*10000;
      Dis_7SEG (FDec, Ftemp, Temperature_L, IsPositive);
...
/***************************************************************************
 ...
 Purpose: 
   Communicate to arduino to write "joel" or change led color
****************************************************************************/
void listen ()
{
  if (Serial.available() > 0) {
    ...
    //CHECK INCOMING BYTE FOR 'O' FOR CHANGING LED
    if(incomingByte == 106){
      joel = true;
    }
